<section class="ffooter">
		<footer class="page-footer">
          <div class="container">
            <div class="row">
              <div class="col l6 s12">
                ...
                <p class="grey-text text-lighten-4">123, Dairy Farm Road, Kanaji Guda , Hyderabad</p>
                <p class="grey-text text-lighten-4">Phone : +91 9951232126</p>
              </div>
          ...
          <div class="footer-copyright">
            <div class="container">
            © 2022 Copyright @ Shiva Restaurants
