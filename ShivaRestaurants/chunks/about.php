<section class="fabout">
		<div class="section white center">
		      <div class="row container">
		        ...
		        <p class="grey-text text-darken-3 lighten-3"><b>WHO WE ARE.</b><br>
...
And we've been delivering that same food and service ever since. </p>
				<a href="/ShivaRestaurants/about-Shiva-Restaurants.php" class="waves-effect waves-light btn" style="background: #ee6e73 !important;">Read More &raquo;</a>
		      </div>
	</section>